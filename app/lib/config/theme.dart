...
/// Couleur de fond personnalisée pour le mode sombre (hors OLED)
const darkBackgroundColor = Color(0xFF0D1318);
...
ColorScheme _determineColorScheme(ColorMode mode, Brightness brightness, DynamicColors? dynamicColors) {
  ...
  if (brightness == Brightness.dark && mode != ColorMode.oled) {
    return resolvedColorScheme.copyWith(surface: darkBackgroundColor);
  }
