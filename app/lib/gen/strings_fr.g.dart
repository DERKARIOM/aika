...
class _Translations$receiveOptionsPage$fr extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(dossier Aika)';
  @override
...
class _Translations$webSharePage$fr extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Aika utilise un certificat auto-signé. Vous devez l\'accepter dans le navigateur.';
  @override
...
class _Translations$networkInterfacesPage$fr extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Par défaut, Aika utilise toutes les interfaces réseau disponibles. Vous pouvez exclure les réseaux indésirables ici. Vous aurez besoin de redémarrer le serveur pour appliquer les changements.';
  @override
  String get preview => 'Aperçu';
  @override
...
class _Translations$settingsTab$general$fr extends Translations$settingsTab$general$en {
  ...
  @override
  String get launchAtStartup => 'Lancer Aika à la connexion de l\'utilisateur';
  @override
  String get launchMinimized => 'Minimiser Aika lors du lancement';
  @override
  String get showInContextMenu => 'Afficher Aika dans le menu contextuel';
  @override
...
class _Translations$settingsTab$other$fr extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Soutenir Aika';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$fr extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Aika ne peut pas trouver d\'autres appareils sans la permission de scanner votre réseau local. Veuillez donner cette permission à Aika dans les paramètres système.';
  @override
...
class _Translations$dialogs$noPermission$fr extends Translations$dialogs$noPermission$en {
  ...
  // Translations
  @override
  String get title => 'Aika n\'a pas la permission';
  @override
...
class _Translations$dialogs$sendModeHelp$fr extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link =>
      'Les destinataires n\'ayant pas Aika installé peuvent télécharger les fichiers sélectionnés en ouvrant le lien dans leur navigateur.';
}
