...
class Translations$qrPairing$display$en {
  ...
  /// en: 'My QR Code'
  String get title => 'My QR Code';

  /// en: 'Pair via QR code'
  String get buttonTooltip => 'Pair via QR code';
  ...
  /// en: 'Expires in {duration}'
  String expiresIn({required Object duration}) => 'Expires in ${duration}';

  /// en: 'Expired'
  String get expired => 'Expired';

  /// en: 'Anyone who scans this code can see this device's alias and connect to it while the code is valid. Regenerate it if you shared it by mistake.'
  String get securityNote =>
      'Anyone who scans this code can see this device\'s alias and connect to it while the code is valid. Regenerate it if you shared it by mistake.';
}

// Path: qrPairing.scan
class Translations$qrPairing$scan$en {
  Translations$qrPairing$scan$en.internal(this._root);
  ...
  /// en: 'Scan a QR code'
  String get buttonTooltip => 'Scan a QR code';
  ...
  String get notFoundInImage => 'No QR code found in this image.';

  /// en: 'Could not reach this device. Make sure both devices are on the same network.'
  String get unreachable => 'Could not reach this device. Make sure both devices are on the same network.';

  /// en: 'This QR code has expired. Ask the other device to generate a new one.'
  String get errorExpired => 'This QR code has expired. Ask the other device to generate a new one.';

  /// en: 'This QR code was generated by an incompatible app version.'
  String get errorUnsupportedVersion => 'This QR code was generated by an incompatible app version.';

  /// en: 'This is not a valid Aika pairing QR code.'
  String get errorMalformed => 'This is not a valid Aika pairing QR code.';

  /// en: 'Live camera scanning is not available on this platform yet. Import a QR code image instead.'
  String get noCameraOnPlatform => 'Live camera scanning is not available on this platform yet. Import a QR code image instead.';

  /// en: 'The camera is not available. Check the app's camera permission.'
  String get cameraUnavailable => 'The camera is not available. Check the app\'s camera permission.';

  /// en: 'Connected to {alias}'
  String pairedSnackbar({required Object alias}) => 'Connected to ${alias}';
}

// Path: qrPairing.confirm
class Translations$qrPairing$confirm$en {
  Translations$qrPairing$confirm$en.internal(this._root);

  final Translations _root; // ignore: unused_field

  // Translations

  /// en: 'Connect to this device?'
  String get title => 'Connect to this device?';

  /// en: 'The connection was verified using the device's certificate. Do you want to pair with it?'
  String get description => 'The connection was verified using the device\'s certificate. Do you want to pair with it?';

  /// en: 'Warning: the device that answered does not match the certificate encoded in the QR code. This may mean the address was reassigned to another device, or a spoofing attempt. Only continue if you are sure.'
  String get fingerprintMismatch =>
      'Warning: the device that answered does not match the certificate encoded in the QR code. This may mean the address was reassigned to another device, or a spoofing attempt. Only continue if you are sure.';
